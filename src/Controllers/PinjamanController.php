...
class PinjamanController extends Controller {
    ...
    public function pinjam() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $id_eksemplar = $_POST['id_eksemplar'] ?? null;
            ...
            if ($result) {
                ...
                $eksemplarModel->update($id_eksemplar, [
                    ...
                    'No_Induk_Inventaris' => $_POST['no_induk_inventaris'] ?? '',
            ...
            $availableEksemplar = null;
            $bookInfo = null;
            
            if ($bookId) {
                // Get available eksemplar for this book
                $eksemplarModel = new EksemplarModel();
                $availableEksemplar = $eksemplarModel->getByBookId($bookId);
                // Filter only available copies
                $availableEksemplar = array_filter($availableEksemplar, function($eksemplar) {
                    return $eksemplar['Status_Ketersediaan'] === 'tersedia';
                });
            ...
            $this->render('pinjaman/pinjam', [
                'title' => 'Peminjaman Buku - Sistem Perpustakaan',
                'bookId' => $bookId,
                'availableEksemplar' => $availableEksemplar,
                'bookInfo' => $bookInfo
            ]);
        }
    }
