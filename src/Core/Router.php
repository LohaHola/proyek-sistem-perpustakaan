...
class Router {
    ...
    public function parseUrl() {
        // Handle root URL - show login form directly
        ...
        foreach ($url as $segment) {
            // If any segment contains invalid characters, fallback to Auth
        ...
        if (isset($url[0]) && $url[0] === 'dashboard') {
            ...
            if (class_exists($controllerClass)) {
                ...
                // If DashboardController doesn't exist, fallback to Auth
                $this->controller = 'Auth';
                $this->method = 'showLoginForm';
            }
        } 
        // Special case: if the URL is 'login', route to AuthController::login
        ...
        // Special case: if the URL is 'cari', route to PencarianController
            ...
            if (class_exists($controllerClass)) {
                ...
                // If PencarianController doesn't exist, fallback to Auth
                $this->controller = 'Auth';
                $this->method = 'showLoginForm';
            }
        }
        // Special case: if the URL is 'kunjungan', route to LogKunjunganController
            ...
            if (class_exists($controllerClass)) {
                ...
                // If LogKunjunganController doesn't exist, fallback to Auth
                $this->controller = 'Auth';
                $this->method = 'showLoginForm';
            }
        }
            ...
            if (isset($url[0]) && !empty($url[0])) {
                ...
                if (class_exists($controllerClass)) {
                    ...
                    // If controller doesn't exist, fallback to Auth
                    $this->controller = 'Auth';
                    $this->method = 'showLoginForm';
